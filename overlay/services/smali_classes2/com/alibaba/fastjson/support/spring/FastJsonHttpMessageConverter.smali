...
.method private readType(Ljava/lang/reflect/Type;Lorg/springframework/http/HttpInputMessage;)Ljava/lang/Object;
    ...
    const-string/jumbo v2, "I/O error while reading input message"
...
.method protected writeInternal(Ljava/lang/Object;Lorg/springframework/http/HttpOutputMessage;)V
    ...
    iget-object v7, p0, Lcom/alibaba/fastjson/support/spring/FastJsonHttpMessageConverter;->fastJsonConfig:Lcom/alibaba/fastjson/support/config/FastJsonConfig;
    ...
    iget-object v9, p0, Lcom/alibaba/fastjson/support/spring/FastJsonHttpMessageConverter;->fastJsonConfig:Lcom/alibaba/fastjson/support/config/FastJsonConfig;
    ...
    invoke-virtual {v4}, Lcom/alibaba/fastjson/support/config/FastJsonConfig;->isWriteContentLength()Z
    ...
    :cond_0
    :try_start_1
    check-cast v3, Lcom/alibaba/fastjson/support/spring/FastJsonContainer;

    .line 229
    invoke-virtual {v3}, Lcom/alibaba/fastjson/support/spring/FastJsonContainer;->getFilters()Lcom/alibaba/fastjson/support/spring/PropertyPreFilters;

    move-result-object v4

    .line 230
    invoke-virtual {v4}, Lcom/alibaba/fastjson/support/spring/PropertyPreFilters;->getFilters()Ljava/util/List;
    ...
    .line 231
    invoke-virtual {v3}, Lcom/alibaba/fastjson/support/spring/FastJsonContainer;->getValue()Ljava/lang/Object;
    ...
    .line 257
    :cond_4
    sget-object v4, Lcom/alibaba/fastjson/support/spring/FastJsonHttpMessageConverter;->APPLICATION_JAVASCRIPT:Lorg/springframework/http/MediaType;

    invoke-virtual {v11, v4}, Lorg/springframework/http/HttpHeaders;->setContentType(Lorg/springframework/http/MediaType;)V
    :try_end_1
    ...
    .line 267
    :try_start_2
    new-instance v4, Lorg/springframework/http/converter/HttpMessageNotWritableException;

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "Could not write JSON: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    invoke-virtual {v3}, Lcom/alibaba/fastjson/JSONException;->getMessage()Ljava/lang/String;
    ...
    invoke-direct {v4, v5, v3}, Lorg/springframework/http/converter/HttpMessageNotWritableException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_3
    invoke-virtual {v11, v4, v5}, Lorg/springframework/http/HttpHeaders;->setContentLength(J)V
    :try_end_3
