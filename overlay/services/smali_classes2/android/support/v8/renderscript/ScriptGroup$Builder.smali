...
.method private calcOrder()Z
    ...
    .end local v4    # "ret":Z
    .local v1, "n0$iterator":Ljava/util/Iterator;
    :cond_0
    :goto_0
    ...
    iget-object v5, v0, Landroid/support/v8/renderscript/ScriptGroup$Node;->mInputs:Ljava/util/ArrayList;
    ...
    .local v3, "n1$iterator":Ljava/util/Iterator;
    :goto_1
    ...
    .line 859
    .local v2, "n1":Landroid/support/v8/renderscript/ScriptGroup$Node;
    iput-boolean v6, v2, Landroid/support/v8/renderscript/ScriptGroup$Node;->mSeen:Z

    goto :goto_1

    .line 861
    .end local v2    # "n1":Landroid/support/v8/renderscript/ScriptGroup$Node;
    :cond_1
    const/4 v5, 0x1
    ...
    .end local v3    # "n1$iterator":Ljava/util/Iterator;
    .end local v4    # "ret":Z
    :cond_2
    iget-object v5, p0, Landroid/support/v8/renderscript/ScriptGroup$Builder;->mNodes:Ljava/util/ArrayList;

    new-instance v6, Landroid/support/v8/renderscript/ScriptGroup$Builder$1;

    invoke-direct {v6, p0}, Landroid/support/v8/renderscript/ScriptGroup$Builder$1;-><init>(Landroid/support/v8/renderscript/ScriptGroup$Builder;)V
...
.method private calcOrderRecurse(Landroid/support/v8/renderscript/ScriptGroup$Node;I)Z
    ...
    iput-boolean v4, p1, Landroid/support/v8/renderscript/ScriptGroup$Node;->mSeen:Z
    ...
    .line 840
    .local v2, "node1":Landroid/support/v8/renderscript/ScriptGroup$Node;
    ...
    .local v2, "node1":Landroid/support/v8/renderscript/ScriptGroup$Node;
    :goto_1
    iget-boolean v4, v2, Landroid/support/v8/renderscript/ScriptGroup$Node;->mSeen:Z
    ...
    invoke-direct {p0, v2, v4}, Landroid/support/v8/renderscript/ScriptGroup$Builder;->calcOrderRecurse(Landroid/support/v8/renderscript/ScriptGroup$Node;I)Z
    ...
    .end local v2    # "node1":Landroid/support/v8/renderscript/ScriptGroup$Node;
    .end local v3    # "ret":Z
    :cond_3
    return v3
.end method
...
.method private validateCycle(Landroid/support/v8/renderscript/ScriptGroup$Node;Landroid/support/v8/renderscript/ScriptGroup$Node;)V
    ...
    invoke-virtual {v2, p2}, Landroid/support/v8/renderscript/ScriptGroup$Node;->equals(Ljava/lang/Object;)Z
...
.method public create()Landroid/support/v8/renderscript/ScriptGroup;
    ...
    invoke-static {v0, v2}, Landroid/support/v8/renderscript/ScriptGroup;->-set0(Landroid/support/v8/renderscript/ScriptGroup;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, v2}, Landroid/support/v8/renderscript/ScriptGroup;->-set1(Landroid/support/v8/renderscript/ScriptGroup;Z)Z
