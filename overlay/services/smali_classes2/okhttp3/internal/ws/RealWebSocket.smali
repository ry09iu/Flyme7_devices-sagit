...
.method static constructor <clinit>()V
    ...
    const-class v1, Lokhttp3/internal/ws/RealWebSocket;
...
.method private declared-synchronized send(Lokio/ByteString;I)Z
    ...
    .line 389
    invoke-virtual {p0, v0, v1}, Lokhttp3/internal/ws/RealWebSocket;->close(ILjava/lang/String;)Z
    :try_end_1
...
.method declared-synchronized close(ILjava/lang/String;J)Z
    ...
    const-string/jumbo v2, "reason.size() > 123: "
...
.method writeOneFrame()Z
    ...
    :cond_5
    :try_start_3
    invoke-virtual {v8, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lokio/ByteString;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    .line 497
    invoke-virtual {v8, v3, v6, v7}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lokio/Sink;
    ...
    invoke-virtual {v8, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILokio/ByteString;)V
...
.method writePingFrame()V
    ...
    const-string/jumbo v3, "sent ping but didn\'t receive pong within "
    ...
    const-string/jumbo v3, "ms (after "
    ...
    const-string/jumbo v2, " successful ping/pongs)"
