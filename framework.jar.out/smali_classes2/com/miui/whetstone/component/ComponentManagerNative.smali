...
.method public control(ILandroid/os/Bundle;)I
    ...
    const-string/jumbo v1, "Cannot invoke this method from system_server"
...
.method public getComponentStartInfo(Ljava/lang/String;Ljava/lang/String;III)Landroid/os/Bundle;
    ...
    const-string/jumbo v7, "Restart: AMS"
    ...
    .line 91
    .end local v1    # "isCallerHasForegroundActivity":Z
    .end local v2    # "isCallerSystemPackage":Z
    .end local v3    # "isCallerSystemUid":Z
    :goto_0
    const-string/jumbo v7, "COMPONET_START_CHECK_AMS_RESTART_SERVICE"

    invoke-virtual {v0, v7, v5}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    .line 92
    const-string/jumbo v7, "COMPONET_START_CHECK_IS_FOREGROUND"

    invoke-virtual {v0, v7, v4}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    .line 93
    const-string/jumbo v7, "COMPONET_START_CHECK_IS_CALLER_HAS_FOREGROUND_ACTIVITIES"

    invoke-virtual {v0, v7, v1}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    .line 94
    const-string/jumbo v7, "COMPONET_START_CHECK_IS_CALLER_SYSTEM_UID"

    invoke-virtual {v0, v7, v3}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    .line 95
    const-string/jumbo v7, "COMPONET_START_CHECK_IS_SYSTEM_CALLER"

    invoke-virtual {v0, v7, v2}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    .line 96
    const-string/jumbo v7, "COMPONET_START_CHECK_IS_SYSTEM_PACKAGE"
    ...
    .line 82
    .restart local v1    # "isCallerHasForegroundActivity":Z
    .restart local v2    # "isCallerSystemPackage":Z
    .restart local v3    # "isCallerSystemUid":Z
    :cond_1
    const/4 v2, 0x0
