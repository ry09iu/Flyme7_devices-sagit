...
.method private init(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "BitmapCacheHandler"
    ...
    const-string/jumbo v5, "whetstone_thumbnails"
    ...
    invoke-virtual {v2, v4, v3}, Lcom/miui/whetstone/graphics/BitmapCache$DiskHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method public addBitmapToCache(Ljava/lang/String;Landroid/graphics/Bitmap;)Ljava/lang/Boolean;
    ...
    const-string/jumbo v4, "add BitmaptoCache key:"
    ...
    const-string/jumbo v4, "the bitmap size has extend size:"
    ...
    const-string/jumbo v3, "[oops] save bitmap exception "
    ...
    const-string/jumbo v4, "[ERROR]add bitmap "
    ...
    const-string/jumbo v4, "bitmap key "
    ...
    const-string/jumbo v4, "has alreaddy add?"
...
.method public clearBitmapFromDiskCache(Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "clearBitmapFromDiskcache key:"
...
.method protected diskInit(Ljava/io/File;)V
    ...
    iput-object v2, p0, Lcom/miui/whetstone/graphics/BitmapCache;->mCache:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 77
    iput v3, p0, Lcom/miui/whetstone/graphics/BitmapCache;->mTotalSize:I
    ...
    const-string/jumbo v4, "Unable to create cache dir "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Lcom/miui/whetstone/graphics/BitmapCache;->mRootDirectory:Ljava/io/File;
...
.method public getBitmapFromDiskCache(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    const-string/jumbo v4, "getBitmapFromDiskCache key:"
    ...
    const-string/jumbo v4, "decode key: "
    ...
    const-string/jumbo v4, " from diskcaceh error"
    ...
    const-string/jumbo v4, "the key is not in cache "
