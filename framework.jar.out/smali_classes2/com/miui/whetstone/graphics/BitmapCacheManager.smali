...
.method static synthetic -get2(Lcom/miui/whetstone/graphics/BitmapCacheManager;)Lcom/miui/whetstone/graphics/BitmapCache;
    .locals 1
...
.method static synthetic -get3(Lcom/miui/whetstone/graphics/BitmapCacheManager;)Landroid/os/Handler;
    .locals 1
...
.method private addBitmapForBitmap(ILandroid/graphics/Bitmap;)V
    ...
    .line 261
    const-string/jumbo v1, "WhetstoneBitmapCache"
    ...
    const-string/jumbo v4, " do not add cache "
...
.method private addBitmapForDrawable(ILandroid/graphics/drawable/BitmapDrawable;)V
    ...
    .line 241
    const-string/jumbo v2, "WhetstoneBitmapCache"
    ...
    const-string/jumbo v5, "bitmap is null , do not add cache, or id is "
...
.method private restoreAllbitmapFromCache(Landroid/app/Activity;)V
    ...
    .line 385
    const-string/jumbo v4, "WhetstoneBitmapCache"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v7, "restore all bitmaps size: "
    ...
    .line 399
    :cond_2
    const-string/jumbo v6, "WhetstoneBitmapCache"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v7, "the bitmap map "
    ...
    const-string/jumbo v7, " has Cached:"
...
.method private trim(I)V
    ...
    .line 312
    iput-boolean v7, p0, Lcom/miui/whetstone/graphics/BitmapCacheManager;->mForeground:Z
...
.method addAllCache(Ljava/util/concurrent/ConcurrentHashMap;)V
    ...
    new-instance v2, Lcom/miui/whetstone/graphics/BitmapCacheManager$BitmapPutListMessage;

    invoke-direct {v2, p0, p1}, Lcom/miui/whetstone/graphics/BitmapCacheManager$BitmapPutListMessage;-><init>(Lcom/miui/whetstone/graphics/BitmapCacheManager;Ljava/util/concurrent/ConcurrentHashMap;)V

    const/4 v3, 0x7

    invoke-virtual {v1, v3, v2}, Lcom/miui/whetstone/graphics/BitmapCache$DiskHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method clearCache(Ljava/lang/Integer;)V
    ...
    new-instance v2, Lcom/miui/whetstone/graphics/BitmapCacheManager$BitmapClearMessage;

    invoke-direct {v2, p0, p1}, Lcom/miui/whetstone/graphics/BitmapCacheManager$BitmapClearMessage;-><init>(Lcom/miui/whetstone/graphics/BitmapCacheManager;Ljava/lang/Integer;)V
...
.method public onTrimMemory(I)V
    ...
    .line 367
    const-string/jumbo v0, "WhetstoneBitmapCache"
    ...
    const-string/jumbo v2, " onTrimMemory #HIDDEN"
...
.method recycleBitmapsAndTrim(Ljava/util/ArrayList;)V
    ...
    const-string/jumbo v5, "recycleBitmapsAndTrim but the app is foreground"
    ...
    const-string/jumbo v6, "end add trim application"
...
.method refreshUI(Landroid/app/Activity;)V
    ...
    const-string/jumbo v1, "refreshUI but the app is background"
    ...
    const-string/jumbo v1, "invalidate window, restore end"
...
.method restoreAllCache(Ljava/util/concurrent/ConcurrentHashMap;Landroid/app/Activity;)V
    ...
    new-instance v2, Lcom/miui/whetstone/graphics/BitmapCacheManager$BitmapRestoreListMessage;

    invoke-direct {v2, p0, p1, p2}, Lcom/miui/whetstone/graphics/BitmapCacheManager$BitmapRestoreListMessage;-><init>(Lcom/miui/whetstone/graphics/BitmapCacheManager;Ljava/util/concurrent/ConcurrentHashMap;Landroid/app/Activity;)V
...
.method restoreBitmaps(Ljava/util/concurrent/ConcurrentHashMap;)V
    ...
    const-string/jumbo v3, "restoreBitmaps but the app is background"
    ...
    const-string/jumbo v3, "restore start"
