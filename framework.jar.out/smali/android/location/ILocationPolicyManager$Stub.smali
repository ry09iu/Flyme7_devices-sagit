...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 47
    :sswitch_0
    const-string/jumbo v11, "android.location.ILocationPolicyManager"
    ...
    .line 57
    .local v5, "_arg1":I
    invoke-virtual {p0, v0, v5}, Landroid/location/ILocationPolicyManager$Stub;->setUidPolicy(II)V
    ...
    invoke-virtual {p0, v0, v5}, Landroid/location/ILocationPolicyManager$Stub;->checkUidLocationOp(II)Z
    ...
    invoke-static {v11}, Landroid/location/ILocationPolicyListener$Stub;->asInterface(Landroid/os/IBinder;)Landroid/location/ILocationPolicyListener;
    ...
    .line 153
    sget-object v11, Landroid/location/LocationPolicy;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 154
    .local v4, "_arg0":[Landroid/location/LocationPolicy;
    invoke-virtual {p0, v4}, Landroid/location/ILocationPolicyManager$Stub;->setLocationPolicies([Landroid/location/LocationPolicy;)V
    ...
    .line 160
    .end local v4    # "_arg0":[Landroid/location/LocationPolicy;
    :sswitch_c
    const-string/jumbo v11, "android.location.ILocationPolicyManager"
    ...
    .line 162
    .local v10, "_result":[Landroid/location/LocationPolicy;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 168
    .end local v10    # "_result":[Landroid/location/LocationPolicy;
    :sswitch_d
    const-string/jumbo v11, "android.location.ILocationPolicyManager"
    ...
    .local v3, "_arg0":Z
    :goto_3
    invoke-virtual {p0, v3}, Landroid/location/ILocationPolicyManager$Stub;->setRestrictBackground(Z)V
    ...
    :goto_5
    invoke-virtual {p0, v3}, Landroid/location/ILocationPolicyManager$Stub;->setFakeGpsFeatureOnState(Z)V
    ...
    .line 203
    :goto_7
    invoke-virtual {p0, v3, v6}, Landroid/location/ILocationPolicyManager$Stub;->setPhoneStationary(ZLandroid/location/Location;)V
    ...
    invoke-virtual {p0, v2}, Landroid/location/ILocationPolicyManager$Stub;->updateGpsBlackPackages(Ljava/util/List;)V
