...
.method private checkUidPermission(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    invoke-interface {v5, p1, p2}, Landroid/content/pm/IPackageManager;->checkUidPermission(Ljava/lang/String;I)I
    :try_end_0
    ...
    invoke-virtual {v8, v4, p2, p3}, Landroid/app/AppOpsManager;->checkOpNoThrow(IILjava/lang/String;)I
    :try_end_1
    ...
    invoke-virtual {v8, v4, p2, p3}, Landroid/app/AppOpsManager;->noteOpNoThrow(IILjava/lang/String;)I
    :try_end_2
...
.method private deleteAccountInCeTableLocked(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/accounts/AccountManagerService$UserAccounts;Landroid/accounts/Account;)Z
    .locals 10
    .param p1, "db"    # Landroid/database/sqlite/SQLiteDatabase;
...
.method private getTypesForCaller(IIZ)Ljava/util/List;
    ...
    .line 5561
    .restart local v3    # "serviceInfo":Landroid/content/pm/RegisteredServicesCache$ServiceInfo;, "Landroid/content/pm/RegisteredServicesCache$ServiceInfo<Landroid/accounts/AuthenticatorDescription;>;"
...
.method private removeAccountInternal(Lcom/android/server/accounts/AccountManagerService$UserAccounts;Landroid/accounts/Account;I)Z
    ...
    aput-object p2, v10, v23

    .line 1886
    move-object/from16 v0, p0

    invoke-direct {v0, v4, v7, v10}, Lcom/android/server/accounts/AccountManagerService;->sendAccountsChangedBroadcast(ILjava/lang/String;[Landroid/accounts/Account;)V
    ...
    invoke-direct {v0, v5, v1, v2}, Lcom/android/server/accounts/AccountManagerService;->deleteAccountInCeTableLocked(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/accounts/AccountManagerService$UserAccounts;Landroid/accounts/Account;)Z
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_1
...
.method private setPasswordInternal(Lcom/android/server/accounts/AccountManagerService$UserAccounts;Landroid/accounts/Account;Ljava/lang/String;I)V
    ...
    .line 2161
    .local v10, "argsAccountId":[Ljava/lang/String;
    const-string/jumbo v2, "ceDb.accounts"

    const-string/jumbo v5, "_id=?"

    .line 2160
    invoke-virtual {v3, v2, v12, v5, v10}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .end local v10    # "argsAccountId":[Ljava/lang/String;
    :cond_2
    :try_start_2
    invoke-virtual {v3}, Landroid/database/sqlite/SQLiteDatabase;->endTransaction()V
    ...
    .line 2183
    invoke-direct {p0, v2, v5, v8}, Lcom/android/server/accounts/AccountManagerService;->sendAccountsChangedBroadcast(ILjava/lang/String;[Landroid/accounts/Account;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
    ...
    .line 2173
    .restart local v10    # "argsAccountId":[Ljava/lang/String;
    :cond_4
    :try_start_3
    ...
    .line 2183
    invoke-direct {p0, v5, v8, v9}, Lcom/android/server/accounts/AccountManagerService;->sendAccountsChangedBroadcast(ILjava/lang/String;[Landroid/accounts/Account;)V
