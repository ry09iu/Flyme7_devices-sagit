...
.method private doRequest(Ljava/lang/String;Lmiui/maml/data/WebServiceBinder$RequestMethod;ZZZ)Ljava/lang/Object;
    ...
    .line 784
    .local v22, "future":Landroid/accounts/AccountManagerFuture;, "Landroid/accounts/AccountManagerFuture<Landroid/os/Bundle;>;"
    const/4 v11, 0x0
    ...
    .line 787
    :try_start_0
    invoke-interface/range {v22 .. v22}, Landroid/accounts/AccountManagerFuture;->getResult()Ljava/lang/Object;
    ...
    .line 790
    .local v21, "extTokenStr":Ljava/lang/String;
    invoke-static/range {v21 .. v21}, Lmiui/maml/data/WebServiceBinder$AuthToken;->parse(Ljava/lang/String;)Lmiui/maml/data/WebServiceBinder$AuthToken;
    :try_end_0
    ...
    .end local v21    # "extTokenStr":Ljava/lang/String;
    ...
    .restart local v29    # "result":Landroid/os/Bundle;
    :cond_3
    :try_start_1
    const-string/jumbo v4, "WebServiceBinder"
    ...
    .end local v22    # "future":Landroid/accounts/AccountManagerFuture;, "Landroid/accounts/AccountManagerFuture<Landroid/os/Bundle;>;"
    :cond_6
    ...
    .line 819
    .local v26, "paramsStr":Ljava/lang/String;
    ...
    .line 821
    .local v31, "strParams":[Ljava/lang/String;
    const/4 v4, 0x0
    ...
    aget-object v23, v31, v4

    .line 822
    .local v23, "pa":Ljava/lang/String;
    ...
    .line 829
    .end local v23    # "pa":Ljava/lang/String;
    .end local v24    # "param":[Ljava/lang/String;
    .end local v31    # "strParams":[Ljava/lang/String;
    :cond_9
    :try_start_3
    move-object/from16 v0, p0
    ...
    .line 831
    .local v27, "resp":Lmiui/maml/util/net/SimpleRequest$StreamContent;
    if-eqz v27, :cond_d
    ...
    .line 836
    .end local v27    # "resp":Lmiui/maml/util/net/SimpleRequest$StreamContent;
    :cond_a
    const/16 v28, 0x0

    .line 837
    .local v28, "resp":Lmiui/maml/util/net/SimpleRequest$StringContent;
    ...
    .line 855
    .end local v28    # "resp":Lmiui/maml/util/net/SimpleRequest$StringContent;
    :goto_3
    if-eqz v28, :cond_d
    ...
    .line 857
    invoke-virtual/range {v28 .. v28}, Lmiui/maml/util/net/SimpleRequest$StringContent;->getBody()Ljava/lang/String;
    ...
    .restart local v28    # "resp":Lmiui/maml/util/net/SimpleRequest$StringContent;
    :pswitch_0
    if-eqz p4, :cond_b
    ...
    .catch Lmiui/maml/util/net/CipherException; {:try_start_3 .. :try_end_3} :catch_6
    .catch Lmiui/maml/util/net/AccessDeniedException; {:try_start_3 .. :try_end_3} :catch_5
    .catch Lmiui/maml/util/net/InvalidResponseException; {:try_start_3 .. :try_end_3} :catch_4
    .catch Lmiui/maml/util/net/AuthenticationFailureException; {:try_start_3 .. :try_end_3} :catch_3
    ...
    .line 874
    .local v18, "e":Lmiui/maml/util/net/AuthenticationFailureException;
    move-object/from16 v0, p0
    ...
    .line 870
    .end local v18    # "e":Lmiui/maml/util/net/AuthenticationFailureException;
    :catch_4
    move-exception v20

    .line 871
    .local v20, "e":Lmiui/maml/util/net/InvalidResponseException;
    move-object/from16 v0, p0
    ...
    .line 882
    .end local v20    # "e":Lmiui/maml/util/net/InvalidResponseException;
    :cond_d
    :goto_4
    const/4 v4, 0x0
    ...
    .line 868
    .local v17, "e":Lmiui/maml/util/net/AccessDeniedException;
    move-object/from16 v0, p0
    ...
    .line 864
    .end local v17    # "e":Lmiui/maml/util/net/AccessDeniedException;
    :catch_6
    move-exception v19

    .line 865
    .local v19, "e":Lmiui/maml/util/net/CipherException;
    move-object/from16 v0, p0
    ...
    .line 861
    .end local v19    # "e":Lmiui/maml/util/net/CipherException;
    :catch_7
    move-exception v16
