...
.method public addSubInfoRecord(Ljava/lang/String;I)I
    ...
    invoke-virtual {v3, v4}, Lcom/android/internal/telephony/SubscriptionControllerInjector;->addActiveSubInfosCache(Landroid/telephony/SubscriptionInfo;)V
    ...
    invoke-virtual {v3, v4, v5, v0}, Lcom/android/internal/telephony/SubscriptionControllerInjector;->updateSubInfoListCache(Landroid/content/Context;ILandroid/content/ContentValues;)V
...
.method public clearSubInfo()I
    ...
    .line 1349
    invoke-static {}, Lcom/android/internal/telephony/SubscriptionControllerInjector;->clearActiveSubInfosCache()V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "sim_id>=0"

    const/4 v8, 0x0

    invoke-direct {p0, v7, v8}, Lcom/android/internal/telephony/SubscriptionController;->getSubInfo(Ljava/lang/String;Ljava/lang/Object;)Ljava/util/List;

    move-result-object v7

    invoke-static {p2, v6, v7}, Lcom/android/internal/telephony/SubscriptionControllerInjector;->dumpDatabaseSubInfoList(Ljava/io/PrintWriter;ZLjava/util/List;)V
...
.method public getActiveSubscriptionInfoList(Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_1
    :try_start_1
    invoke-static {}, Lcom/android/internal/telephony/SubscriptionControllerInjector;->getActiveSubInfoListCache()Ljava/util/List;
...
.method protected setCarrierText(Ljava/lang/String;I)I
    .locals 10
    ...
    .line 924
    invoke-static {p2, p1}, Lcom/android/internal/telephony/SubscriptionControllerInjector;->carrierNameEqualsCache(ILjava/lang/String;)Z
    ...
    invoke-virtual {v4, v5, p2, v3}, Lcom/android/internal/telephony/SubscriptionControllerInjector;->updateSubInfoListCache(Landroid/content/Context;ILandroid/content/ContentValues;)V
...
.method public setDisplayNameUsingSrc(Ljava/lang/String;IJ)I
    ...
    :goto_0
    invoke-static {p2, v2, p3, p4}, Lcom/android/internal/telephony/SubscriptionControllerInjector;->displayNameUsingSrcEqualsCache(ILjava/lang/String;J)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v5, v6, p2, v4}, Lcom/android/internal/telephony/SubscriptionControllerInjector;->updateSubInfoListCache(Landroid/content/Context;ILandroid/content/ContentValues;)V
...
.method public setMccMnc(Ljava/lang/String;I)I
    ...
    .prologue
    .line 1132
    invoke-static {p1, p2}, Lcom/android/internal/telephony/SubscriptionControllerInjector;->updateMccMnc(Ljava/lang/String;I)V
...
.method protected setMccMncInternal(Ljava/lang/String;I)I
    .locals 10
    .param p1, "mccMnc"    # Ljava/lang/String;
    .param p2, "subId"    # I
    ...
    .line 1146
    :goto_0
    invoke-static {p2, v1, v2}, Lcom/android/internal/telephony/SubscriptionControllerInjector;->mccMncEqualsCache(III)Z
...
.method public setPlmnSpn(IZLjava/lang/String;ZLjava/lang/String;)Z
    ...
    invoke-interface {v4, v6}, Ljava/util/Map;->containsValue(Ljava/lang/Object;)Z
    ...
    const-string/jumbo v6, "ignore setCarrierText: "
    ...
    const-string/jumbo v6, ", because it\'s dummy subId."
    ...
    invoke-static {v0, v4}, Lcom/android/internal/telephony/SubscriptionControllerInjector;->updateCarrierText(Ljava/lang/String;I)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
