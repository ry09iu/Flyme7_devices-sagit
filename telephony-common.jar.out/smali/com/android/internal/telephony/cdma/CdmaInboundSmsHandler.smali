...
.method private processCdmaWapPdu([BILjava/lang/String;J)I
    ...
    iget-object v2, v0, Lcom/android/internal/telephony/cdma/CdmaInboundSmsHandler;->mPhone:Lcom/android/internal/telephony/Phone;
    ...
    const-string/jumbo v4, "processCdmaWapPdu setSubId = "

    invoke-virtual {v2, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/InboundSmsTracker;->getSubId()I
