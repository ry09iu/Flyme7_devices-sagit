...
.method restoreOneFile(Ljava/io/InputStream;[B)Z
    ...
    .line 6899
    .local v26, "info":Lcom/android/server/backup/BackupManagerService$FileMetadata;
    if-eqz v26, :cond_2
    ...
    invoke-virtual {v0, v4, v7}, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->tearDownAgent(Landroid/content/pm/ApplicationInfo;Z)V
    ...
    .line 7185
    .end local v26    # "info":Lcom/android/server/backup/BackupManagerService$FileMetadata;
    ...
    .line 6932
    .restart local v26    # "info":Lcom/android/server/backup/BackupManagerService$FileMetadata;
    ...
    check-cast v35, Lcom/android/server/backup/BackupManagerService$RestorePolicy;

    .line 6942
    .local v35, "policy":Lcom/android/server/backup/BackupManagerService$RestorePolicy;
    move-object/from16 v0, v26
    ...
    invoke-virtual/range {v35 .. v35}, Lcom/android/server/backup/BackupManagerService$RestorePolicy;->ordinal()I
    ...
    .line 7118
    .local v32, "pipe":Ljava/io/FileOutputStream;
    :cond_b
    :goto_8
    const-wide/16 v8, 0x0
    ...
    .end local v32    # "pipe":Ljava/io/FileOutputStream;
    .end local v33    # "pipeOkay":Z
    :cond_e
    :goto_a
    if-nez v20, :cond_f
    ...
    .restart local v32    # "pipe":Ljava/io/FileOutputStream;
    .restart local v33    # "pipeOkay":Z
    :cond_18
    ...
    .end local v34    # "pkg":Ljava/lang/String;
    .end local v35    # "policy":Lcom/android/server/backup/BackupManagerService$RestorePolicy;
    :cond_1c
    const/4 v4, 0x0
...
.method public run()V
    ...
    invoke-static {v0, v1}, Lcom/android/server/backup/BackupManagerServiceInjector;->errorOccur(II)V
    :try_end_6
    .catch Ljava/io/IOException; {:try_start_6 .. :try_end_6} :catch_1
...
.method tearDownAgent(Landroid/content/pm/ApplicationInfo;Z)V
    ...
    iget-object v5, p0, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->mInputFile:Landroid/os/ParcelFileDescriptor;

    invoke-virtual {v5}, Landroid/os/ParcelFileDescriptor;->getFd()I

    move-result v5

    invoke-static {v4, v5}, Lcom/android/server/backup/BackupManagerServiceInjector;->isNeedBeKilled(Ljava/lang/String;I)Z
