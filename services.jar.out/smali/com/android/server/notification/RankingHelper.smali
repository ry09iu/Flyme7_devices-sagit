...
.method private getOrCreateRecord(Ljava/lang/String;I)Lcom/android/server/notification/RankingHelper$Record;
    ...
    invoke-direct {v1, v2}, Lcom/android/server/notification/RankingHelper$Record;-><init>(Lcom/android/server/notification/RankingHelper$Record;)V
...
.method public onPackagesChanged(Z[Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v8, v9}, Landroid/content/pm/PackageManager;->getPackageUidAsUser(Ljava/lang/String;I)I

    move-result v8

    iput v8, v3, Lcom/android/server/notification/RankingHelper$Record;->uid:I

    .line 534
    iget-object v8, p0, Lcom/android/server/notification/RankingHelper;->mRestoredWithoutUids:Landroid/util/ArrayMap;

    invoke-virtual {v8, v1}, Landroid/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    .line 535
    iget-object v8, p0, Lcom/android/server/notification/RankingHelper;->mRecords:Landroid/util/ArrayMap;

    iget-object v9, v3, Lcom/android/server/notification/RankingHelper$Record;->pkg:Ljava/lang/String;

    iget v10, v3, Lcom/android/server/notification/RankingHelper$Record;->uid:I
...
.method public readXml(Lorg/xmlpull/v1/XmlPullParser;Z)V
    ...
    invoke-static {p1, v7, v9}, Lcom/android/server/notification/RankingHelper;->safeInt(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)I
...
.method public writeXml(Lorg/xmlpull/v1/XmlSerializer;Z)V
    ...
    invoke-interface {p1, v7, v4, v6}, Lorg/xmlpull/v1/XmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    .restart local v1    # "hasNonDefaultSettings":Z
    goto :goto_2
