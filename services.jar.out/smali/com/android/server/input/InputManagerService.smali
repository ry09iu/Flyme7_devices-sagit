...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/input/InputManagerService$MiuiInputFilter;,
...
.field static sMiuiInputFilter:Lcom/android/server/input/InputManagerService$MiuiInputFilter;
...
.method private notifySwitch(JII)V
    ...
    invoke-interface {v7, p1, p2, v4}, Lcom/android/server/input/InputManagerService$WindowManagerCallbacks;->notifyLidSwitchChanged(JZ)V

    .line 1971
    const/4 v5, 0x0

    .line 1972
    .local v5, "mCitEnabled":I
    :try_start_0
    const-string/jumbo v7, "sys.cit.halltest"
    ...
    const-string/jumbo v7, "android.intent.action.HALL_CHANGE"

    invoke-direct {v6, v7}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1975
    .local v6, "statusIntent":Landroid/content/Intent;
    const-string/jumbo v7, "hall_status"
    ...
    .line 1985
    .end local v4    # "lidOpen":Z
    .end local v5    # "mCitEnabled":I
    .end local v6    # "statusIntent":Landroid/content/Intent;
    :cond_0
    :goto_1
    and-int/lit8 v7, p4, 0x12

    if-eqz v7, :cond_1

    .line 1986
    and-int/lit8 v7, p3, 0x12
    ...
    invoke-interface {v7, p1, p2, v1}, Lcom/android/server/input/InputManagerService$WindowManagerCallbacks;->notifyBackLidSwitchChanged(JZ)V
    ...
    .line 1993
    .local v3, "lensCovered":Z
    :goto_3
    iget-object v7, p0, Lcom/android/server/input/InputManagerService;->mWindowManagerCallbacks:Lcom/android/server/input/InputManagerService$WindowManagerCallbacks;

    invoke-interface {v7, p1, p2, v3}, Lcom/android/server/input/InputManagerService$WindowManagerCallbacks;->notifyCameraLensCoverSwitchChanged(JZ)V

    .line 1996
    .end local v3    # "lensCovered":Z
    :cond_2
    iget-boolean v7, p0, Lcom/android/server/input/InputManagerService;->mUseDevInputEventForAudioJack:Z

    if-eqz v7, :cond_3

    and-int/lit16 v7, p4, 0xd4

    if-eqz v7, :cond_3

    .line 1997
    iget-object v7, p0, Lcom/android/server/input/InputManagerService;->mWiredAccessoryCallbacks:Lcom/android/server/input/InputManagerService$WiredAccessoryCallbacks;

    invoke-interface {v7, p1, p2, p3, p4}, Lcom/android/server/input/InputManagerService$WiredAccessoryCallbacks;->notifyWiredAccessoryChanged(JII)V
    ...
    iput-object v7, v0, Lcom/android/internal/os/SomeArgs;->arg1:Ljava/lang/Object;
    ...
    invoke-virtual {v7, v8, v0}, Lcom/android/server/input/InputManagerService$InputManagerHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    .restart local v4    # "lidOpen":Z
    goto :goto_0

    .line 1978
    .restart local v5    # "mCitEnabled":I
    :catch_0
    move-exception v2
    ...
    const-string/jumbo v8, "Try to get SystemProperty: sys.cit.halltest failed!"
    ...
    .restart local v1    # "backLidOpen":Z
    goto :goto_2
    ...
    .restart local v3    # "lensCovered":Z
    goto :goto_3
...
.method public setInputFilter(Landroid/view/IInputFilter;)V
    ...
    .line 650
    sget-object p1, Lcom/android/server/input/InputManagerService;->sMiuiInputFilter:Lcom/android/server/input/InputManagerService$MiuiInputFilter;
...
.method public start()V
    ...
    .line 426
    new-instance v0, Lcom/android/server/input/InputManagerService$MiuiInputFilter;

    iget-object v1, p0, Lcom/android/server/input/InputManagerService;->mContext:Landroid/content/Context;

    invoke-direct {v0, p0, v1}, Lcom/android/server/input/InputManagerService$MiuiInputFilter;-><init>(Lcom/android/server/input/InputManagerService;Landroid/content/Context;)V

    sput-object v0, Lcom/android/server/input/InputManagerService;->sMiuiInputFilter:Lcom/android/server/input/InputManagerService$MiuiInputFilter;
    ...
    .line 447
    invoke-virtual {p0, v4}, Lcom/android/server/input/InputManagerService;->setInputFilter(Landroid/view/IInputFilter;)V
...
.method public systemRunning()V
    ...
    const-string/jumbo v3, "gesture_wakeup"
