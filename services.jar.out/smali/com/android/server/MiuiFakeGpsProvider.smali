...
.method private handleSetRequest(Lcom/android/internal/location/ProviderRequest;)V
    ...
    .line 159
    .local v0, "lr":Landroid/location/LocationRequest;
    ...
    .line 164
    .end local v0    # "lr":Landroid/location/LocationRequest;
...
.method private isProviderNeedChange(Z)Z
    ...
    .line 326
    .local v5, "opsManager":Landroid/app/AppOpsManager;
    ...
    .end local v4    # "ops":[I
    .end local v5    # "opsManager":Landroid/app/AppOpsManager;
    :cond_0
    const/4 v8, 0x2
    ...
    .restart local v4    # "ops":[I
    goto :goto_0

    .line 332
    .restart local v0    # "appOps":Ljava/util/List;, "Ljava/util/List<Landroid/app/AppOpsManager$PackageOps;>;"
    .restart local v5    # "opsManager":Landroid/app/AppOpsManager;
    :cond_1
    invoke-interface {v0}, Ljava/lang/Iterable;->iterator()Ljava/util/Iterator;

    move-result-object v7

    .local v7, "pkgops$iterator":Ljava/util/Iterator;
    :cond_2
