...
.method private bindLocked()V
    ...
    .line 617
    :cond_0
    iget-boolean v5, p0, Lcom/android/server/print/RemotePrintSpooler;->mIsLowPriority:Z
    ...
    .local v2, "flags":I
    :goto_0
    iget-object v5, p0, Lcom/android/server/print/RemotePrintSpooler;->mContext:Landroid/content/Context;

    iget-object v10, p0, Lcom/android/server/print/RemotePrintSpooler;->mIntent:Landroid/content/Intent;

    iget-object v11, p0, Lcom/android/server/print/RemotePrintSpooler;->mServiceConnection:Landroid/content/ServiceConnection;

    iget-object v12, p0, Lcom/android/server/print/RemotePrintSpooler;->mUserHandle:Landroid/os/UserHandle;

    invoke-virtual {v5, v10, v11, v2, v12}, Landroid/content/Context;->bindServiceAsUser(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
    ...
    .line 628
    const-string/jumbo v5, "RemotePrintSpooler"
    ...
    const-string/jumbo v11, "] bindService failed"
    ...
    const-string/jumbo v10, "bindError"
    ...
    sget-wide v10, Lcom/android/server/print/RemotePrintSpooler;->BIND_SPOOLER_SERVICE_TIMEOUT:J

    sub-long v6, v10, v0

    .line 640
    .local v6, "remainingMillis":J
    ...
    const-string/jumbo v10, "Cannot get spooler!"
