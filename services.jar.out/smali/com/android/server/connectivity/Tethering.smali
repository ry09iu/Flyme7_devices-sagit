...
.method static synthetic -wrap9(Lcom/android/server/connectivity/Tethering;I)V
    .locals 0
    .param p1, "icon"    # I
...
.method private sendTetherConnectStateChangedBroadcast()V
    ...
    const-string/jumbo v4, "codeaurora.net.conn.TETHER_CONNECT_STATE_CHANGED"
    ...
    invoke-direct {p0, v4}, Lcom/android/server/connectivity/Tethering;->isWifi(Ljava/lang/String;)Z
    ...
    .line 683
    iget-object v4, v3, Lcom/android/server/connectivity/Tethering$TetherState;->mStateMachine:Lcom/android/server/connectivity/tethering/TetherInterfaceStateMachine;

    invoke-virtual {v4}, Lcom/android/server/connectivity/tethering/TetherInterfaceStateMachine;->getHandler()Landroid/os/Handler;

    move-result-object v4

    new-instance v5, Lcom/android/server/connectivity/Tethering$3;

    invoke-direct {v5, p0}, Lcom/android/server/connectivity/Tethering$3;-><init>(Lcom/android/server/connectivity/Tethering;)V
